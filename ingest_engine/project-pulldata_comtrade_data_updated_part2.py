...
default_args = {
	'owner': 'project-pulldata_comtrade_data_update_part2',
	'start_date': datetime.datetime(2021, 1, 17, 20, 00, 00),
	'concurrency': 1,
	'retries': 0
}

with DAG('project-pulldata_comtrade_data_update_part2',
     catchup=False,
    ...
    comtrade_update_2 = PythonOperator(task_id='get_data',
