...
from pardot_utils.constants import B2C_DATASET, PROSPECTS_API, PROSPECTS_TABLE, B2C_EMAIL, \
    B2C_PASSWORD, B2C_USER_KEY, B2C_PROSPECTS_LOG, PROSPECTS_DATA_NAME, GET_BATCH_URL
...
def upload_data() -> bool:
    ...
    log_file = f'{LOGS_FOLDER}{B2C_PROSPECTS_LOG}'
    ...
    if not final_df.empty:
        ...
        # upload data to gbq
        final_df.to_gbq(destination_table=f'{dataset}.{table}',
