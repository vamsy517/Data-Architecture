...
from pardot_utils.constants import B2C_DATASET, EMAIL_API, EMAIL_CLICKS_TABLE, EMAILS_TABLE, B2C_EMAIL, \
    B2C_PASSWORD, B2C_USER_KEY, B2C_EMAIL_LOG, EMAILS_DATA_NAME, GET_BATCH_URL
...
def upload_data() -> bool:
    ...
    log_file = f'{LOGS_FOLDER}{B2C_EMAIL_LOG}'
