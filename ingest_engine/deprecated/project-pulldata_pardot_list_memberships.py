...
def log_update(ids, table):
    ...
    with open ('/home/ingest/logs/update_pardot_list_memberships_results.csv', 'a') as fl:
...
def upload_data():
    ...
    max_created_updated = get_max(project_id, 'Pardot', 'List_Memberships')
