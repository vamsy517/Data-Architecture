...
def log_upload(dataset, table, process, lst_ids = None):
    ...
    '''
    with open ('/home/ingest/logs/update_surveys_gd_processing_results.csv', 'a') as fl:
...
def update_data():
    ...
    # get list of surveys
    print(f'Download full list of GlobalData surveys')
    ...
    for page in range(nb_pages):
        ...
        df_single_page = df_single_page[df_single_page['team'] == '645198'] 
    ...
    df_surveys = df_surveys[~df_surveys['title'].str.startswith('Test-')]
    print(f'Finished download of full list of GlobalData surveys')
    ...
    print(f'Download descriptions for GlobalData surveys')
    ...
    print(f'Finished download of descriptions for GlobalData surveys')
    ...
    print(f'Download questions for GlobalData surveys')
    ...
    print(f'Finished download of questions for GlobalData surveys')
    ...
    print(f'Download questions options for GlobalData surveys')
    ...
    print(f'Finished download of questions options for GlobalData surveys')
    ...
    print(f'Download responses for GlobalData surveys')
    ...
    for survey in surveys_lst:
        ...
        try:
            ...
            print('Tried unsuccessfully with survey id ', survey)
            continue
    print(f'Finished download of responses for GlobalData surveys')
    ...
    for col in df1.columns:
        if col.isdigit():
            a = pd.DataFrame(df1[[col,'responseID','surveyID']].dropna(subset=[f'{col}']))
    ...
    print(f'Download campaigns for GlobalData surveys')
    ...
    print(f'Finished download of campaigns for GlobalData surveys')
    ...
    lst_reports = []
    print(f'Download reports for GlobalData surveys')
    ...
    print(f'Finished download of reports for GlobalData surveys')
    ...
    lst_statistics = []
    print(f'Download statistics for GlobalData surveys')
    ...
    for survey in surveys_lst:
        ...
        try:
            ...
            print('Tried unsuccessfully with survey id ', survey)
            continue
    print(f'Finished download of statistics for GlobalData surveys')
...
with DAG('project-pulldata_alchemer_gd_data_update',
    ...
    alchemer_gd_update = PythonOperator(task_id='update_data',
