...
from pardot_utils.constants import B2B_DATASET, LISTS_API, LISTS_TABLE, B2B_EMAIL, \
    B2B_PASSWORD, B2B_USER_KEY, B2B_LISTS_LOG, LISTS_DATA_NAME, GET_BATCH_URL
...
def upload_data() -> bool:
    ...
    log_file = f'{LOGS_FOLDER}{B2B_LISTS_LOG}'
