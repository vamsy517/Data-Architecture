...
from pardot_utils.constants import B2C_DATASET, B2C_EMAIL, B2C_PASSWORD, B2C_USER_KEY
from ingest_utils.database_gbq import get_gbq_table, upload_table_to_gbq
from ingest_utils.constants import PULLDATA_PROJECT_ID, PERMUTIVE_PARDOT_MATCH_LOG_B2C
...
def update_error_log(context):
    ...
    fix_log_error(emails, PERMUTIVE_PARDOT_MATCH_LOG_B2C)


default_args = {
    'owner': 'project-pulldata_permutive_pardot_match_update_b2c',
    'start_date': datetime.datetime(2021, 2, 9, 21, 1, 00),
    'concurrency': 1,
    'retries': 0
}

with DAG('project-pulldata_permutive_pardot_match_update_b2c',
         catchup=False,
