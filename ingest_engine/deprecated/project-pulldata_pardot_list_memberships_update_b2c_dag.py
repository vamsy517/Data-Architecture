...
from pardot_utils.constants import B2C_DATASET, LIST_MEMBERSHIP_API, LIST_MEMBERSHIP_TABLE, B2C_EMAIL, \
    B2C_PASSWORD, B2C_USER_KEY, B2C_LIST_MEMBERSHIP_LOG, LIST_MEMBERSHIP_DATA_NAME, GET_BATCH_URL
...
def upload_data() -> bool:
    ...
    log_file = f'{LOGS_FOLDER}{B2C_LIST_MEMBERSHIP_LOG}'
